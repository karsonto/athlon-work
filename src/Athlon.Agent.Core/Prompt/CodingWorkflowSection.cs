...
public sealed class CodingWorkflowSection : IEnvironmentPromptSection
{
    ...
    public void Append(StringBuilder builder, EnvironmentPromptContext context)
    {
        ...
        builder.AppendLine("- Planning: for multi-step or multi-file tasks, explore with grep_files, glob_files, and file_read first; in Coding mode use todo_write for structured steps when available, otherwise state a brief plan before editing.");

...
{
    public string Name => "workflow:plan";

    public int Order => PromptSectionBands.WorkflowStart;
    ...
    public void Append(StringBuilder builder, EnvironmentPromptContext context)
    {
        ...
        if (PromptModeHelper.HasTool(context, "create_plan"))
        {
        ...
        if (PromptModeHelper.HasTool(context, "update_plan"))
        {
        ...
        builder.AppendLine("- After create_plan or update_plan: end the turn and wait. Do not call write/patch/shell tools.");

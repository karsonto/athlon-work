...
public partial class LeftSidebarToggleIcon : UserControl
{
    ...
    public static readonly DependencyProperty IsPanelOpenProperty =
        DependencyProperty.Register(
            nameof(IsPanelOpen),
            typeof(bool),
            typeof(LeftSidebarToggleIcon),
            new PropertyMetadata(true, OnIsPanelOpenChanged));

    public LeftSidebarToggleIcon()
    {
        InitializeComponent();
    ...
    {
        if (d is LeftSidebarToggleIcon icon && e.NewValue is bool isOpen)
        {

...
public static class ThemeBrushResolver
{
    ...
    private static Color ResolveColor(string key)
    {
        ...
        return key switch
        {
            ...
            "Brush.ModePlanBg" => chrome.ModePlanBg,
            "Brush.ModePlanBorder" => chrome.ModePlanBorder,
            "Brush.ModePlanForeground" => chrome.ModePlanForeground,
            "Brush.ModeDebugBg" => chrome.ModeDebugBg,
            "Brush.ModeDebugBorder" => chrome.ModeDebugBorder,
            "Brush.ModeDebugForeground" => chrome.ModeDebugForeground,

...
{
    public ToolDefinition Definition { get; } = new("file_write", "Create or overwrite a file.", new Dictionary<string, string> { ["path"] = ToolPathDescriptions.WorkspaceRelativePath, ["content"] = "New content" }, RequiresApproval: true);

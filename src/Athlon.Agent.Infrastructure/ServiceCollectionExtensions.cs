...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddAthlonInfrastructure(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IChatDocumentAttachmentExtractor, ChatDocumentAttachmentExtractor>();
        ...
        services.AddSingleton<IRuntimeContextContributor, ApprovedPlanPromptContributor>();

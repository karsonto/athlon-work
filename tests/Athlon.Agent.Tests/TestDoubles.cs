...
internal sealed class NoOpStorage : IFileStorageService
{
    ...
    public Task<ConversationDisplayPage> LoadConversationDisplayPageAsync(string sessionId, ConversationDisplayCursor? cursor = null, int pageSize = 100, CancellationToken cancellationToken = default) =>

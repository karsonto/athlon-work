...
- On **Windows 11**, the app uses the system Evergreen WebView2 Runtime (already installed on most machines).
- On **Windows 10**, the app tries the bundled Fixed Version first, then falls back to Evergreen if needed.
